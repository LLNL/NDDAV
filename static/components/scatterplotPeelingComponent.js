class scatterplotPeelingComponent extends baseComponent {
    constructor(uuid) {
        super(uuid);
        console.log("########## ScatterplotPeelingModule class ###########");
        this.addModule("ScatterplotPeelingModule", ['data', 'subselection',
            'seg', 'embedding'
        ]);
        this.sPlot = new peelingPlot(this.getDiv());
